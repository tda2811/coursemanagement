...
* The original package name 'course.enzo.project.course-enzo-demo' is invalid and this project uses 'course.enzo.project.courseenzodemo' instead.
...
* [JDBC API](https://docs.spring.io/spring-boot/docs/3.0.9/reference/htmlsingle/index.html#data.sql)
